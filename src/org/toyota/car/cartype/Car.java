...
public abstract class Car {
    ...
    public Car(ColorCar color, int maxSpeed, TransmissionType transmissionType, boolean isMove, double price,
    ...
    public String toString() {
        ...
        return getClass() + "{color=" + color + ", maxSpeed=" + maxSpeed + ", price=" + price +
                ", carWheelRadius=" + carWheelRadius +'}';
    }
